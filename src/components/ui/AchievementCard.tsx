...
export default function AchievementCard(data: AchievementItem) {
    ...
    return (
        <>
            <div id="achievementCard" className={`items-center md:items-start w-full border h-auto rounded-2xl p-6 
                        ...
                        <div className="flex flex-col gap-1 w-full items-start">
                            <div className="flex flex-col gap-2 items-start">
                                <div className="flex flex-row items-center gap-1">
                                    <Image
                                        src="/icons/icons8-trophy-100.png"
                                        alt="Trophy Icon"
                                        width={20} height={20}
                                        className="rounded-full flex-0 object-contain"
                                    >
                                    </Image>
                                    <p className={`uppercase ${theme == "dark" ? "text-gray-300" : "text-indigo-600"} text-sm`}>Achievement</p>
                                </div>
