        ...
        <div className="relative" ref={dropdownRef}>
            ...
            <motion.button
                ...
                className={`
                    ...
                    ${currentMode === 'fullstack'
                        ? 'border-indigo-500 bg-indigo-50 hover:bg-indigo-100 dark:bg-indigo-950/30 dark:hover:bg-indigo-950/50'
                        : 'border-purple-500 bg-purple-50 hover:bg-purple-100 dark:bg-purple-950/30 dark:hover:bg-purple-950/50'
                    }
                `}
            >
                <div className={`
            ...
            {isOpen && (
                <motion.div
                    ...
                    className="absolute left-0 right-0 mt-2 rounded-2xl shadow-xl border overflow-hidden z-50 bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-800"
                >
                    {modes.map((mode) => {
