        ...
        <nav className="flex justify-center mt-6 mb-6 sticky top-4 z-50 px-4">
            <div className="relative w-full max-w-6xl">
                ...
                <div className="hidden min-[1060px]:flex items-center justify-center">
                    <div className={`flex items-center border border-slate-300 dark:border-slate-700 backdrop-blur-md shadow-sm rounded-full px-6 py-3 gap-6`}>
                        {mode && (
                            <Link
                                href="#home"
                ...
                <div className="flex min-[1060px]:hidden items-center justify-between">
                    ...
                    >
                        <div className={`flex items-center border border-slate-300 dark:border-slate-700 backdrop-blur-md shadow-sm rounded-full px-2 py-2`}>
                            {mode && (
                                <div className={`
...
hover:bg-slate-100 dark:hover:bg-slate-800`}
                ...
                {isMenuOpen && (
                    <div className="absolute top-16 left-0 right-0 min-[1060px]:hidden">
                        <div className={`border bg-white/90 border-slate-300 dark:bg-slate-900/90 dark:border-slate-700 backdrop-blur-md shadow-lg rounded-2xl py-2 px-2`}>
                            <Link
                                href="#home"
                                className={`block px-4 py-3 rounded-lg transition ${
                                    active === 'home'
                                        ? 'bg-slate-100 text-pink-600 dark:bg-slate-800 dark:text-blue-400'
                                        : 'hover:bg-slate-100 text-gray-800 dark:hover:bg-slate-800 dark:text-gray-200'
                                }`}
                                onClick={(e) => handleLinkClick(e, 'home')}
                                onKeyDown={(e) => handleKeyDown(e, 'home')}
                            >
